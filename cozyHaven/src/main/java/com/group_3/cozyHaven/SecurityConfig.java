...
//	            .requestMatchers("/hotel/delete/{hotelId}").hasRole("SERVICE_PROVIDER")
 //               .requestMatchers("/room/image/upload/{roomId}").permitAll()
	//            .requestMatchers("/hotel/addHotel").permitAll()          //hasRole("SERVICE_PROVIDER")
//	            .requestMatchers("/room/add/{hotelId}").permitAll()  //hasRole("SERVICE_PROVIDER")
//	            .requestMatchers("/image/upload/{hotelId}/{roomId}").permitAll() //hasRole("SERVICE_PROVIDER")
...
//                .requestMatchers("/room/updateAvailability").permitAll()  //hasRole("SERVICE_PROVIDER")
...
//	            .requestMatchers("/image/{roomId}/urls").permitAll()	
//	            
//	            .requestMatchers("/hotel/delete/{hotelId}").permitAll()  // Allow all users to delete hotel
//	                
//	            
...
//	            
//	            .requestMatchers("/package/search").permitAll()//asRole("CUSTOMER")
