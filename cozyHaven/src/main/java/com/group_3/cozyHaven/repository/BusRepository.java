...
public interface BusRepository extends JpaRepository<Bus, Integer> {
	...
	@Query("SELECT b.name, b.number, b.type, bp.name, bp.age, bs.seatNumber, bs.seatType, bb.date, bb.source, bb.destination, bb.status FROM BusSeatBooking bsb JOIN bsb.busBooking bb JOIN bsb.busSeat bs JOIN bs.bus b JOIN BusPassenger bp ON bp.busBooking.id=bb.id WHERE bb.id=?1 GROUP BY bp.id")
